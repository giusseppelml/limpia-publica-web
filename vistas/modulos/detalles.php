  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
         ...
         <button type="button" class="btn btn-default pull-right" id="daterangedetalles-btn">
      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
        ...
        $variable=$_GET["variable"];
          ...
          $respuesta = ControladorDetalles::ctrRangoFechasDetalles($fechaInicial, $fechaFinal, $variable);
      ...
      $eliminarVenta = new ControladorDetalles();
