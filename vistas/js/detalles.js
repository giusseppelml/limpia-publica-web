...
if(localStorage.getItem("capturarRango") != null){
	...
	$("#daterangedetalles-btn span").html(localStorage.getItem("capturarRango"));


}else{

	$("#daterangedetalles-btn span").html('<i class="fa fa-calendar"></i> Rango de fecha')
...
RANGO DE FECHAS
=============================================*/
$('#daterangedetalles-btn').daterangepicker(
  {
    /*ranges   : {
      'Hoy'       : [moment(), moment()],
  ...
  function (start, end) {
    $('#daterangedetalles-btn span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));

    var fechaInicial = start.format('YYYY-MM-DD');

    var fechaFinal = end.format('YYYY-MM-DD');

    var capturarRango = $("#daterangedetalles-btn span").html();
	...
	var cobrador = $("#campocobrador").attr("value");
   	...
   	window.location = "index.php?ruta=detalles&variable="+cobrador+"&fechaInicial="+fechaInicial+"&fechaFinal="+fechaFinal;
