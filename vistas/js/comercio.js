...
if(localStorage.getItem("capturarRango") != null){
	...
	$("#daterangec-btn span").html(localStorage.getItem("capturarRango"));


}else{

	$("#daterangec-btn span").html('<i class="fa fa-calendar"></i> Rango de fecha')
...
$(".tablas").on("click", ".btnEliminarVenta", function(){
  ...
  swal({
        ...
        if (result.value) {
            ...
            window.location = "index.php?ruta=comercio&idVenta="+idVenta;
        }
...
$('#daterangec-btn').daterangepicker(
  ...
  function (start, end) {
    ...
    var capturarRango = $("#daterangec-btn span").html();
   
   	localStorage.setItem("capturarRango", capturarRango);

   	window.location = "index.php?ruta=comercio&fechaInicial="+fechaInicial+"&fechaFinal="+fechaFinal;
