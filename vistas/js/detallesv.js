...
if(localStorage.getItem("capturarRango") != null){
	...
	$("#daterangedetallesv-btn span").html(localStorage.getItem("capturarRango"));


}else{

	$("#daterangedetallesv-btn span").html('<i class="fa fa-calendar"></i> Rango de fecha')
...
RANGO DE FECHAS
=============================================*/
$('#daterangedetallesv-btn').daterangepicker(
  {
    /*ranges   : {
      'Hoy'       : [moment(), moment()],
  ...
  function (start, end) {
    $('#daterangedetallesv-btn span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));

    var fechaInicial = start.format('YYYY-MM-DD');

    var fechaFinal = end.format('YYYY-MM-DD');

    var capturarRango = $("#daterangedetallesv-btn span").html();
