...
if(localStorage.getItem("capturarRango") != null){
	...
	$("#daterangecc-btn span").html(localStorage.getItem("capturarRango"));


}else{

	$("#daterangecc-btn span").html('<i class="fa fa-calendar"></i> Rango de fecha')
...
RANGO DE FECHAS
=============================================*/
$('#daterangecc-btn').daterangepicker(
  {
    /*ranges   : {
      'Hoy'       : [moment(), moment()],
  ...
  function (start, end) {
    $('#daterangecc-btn span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));

    var fechaInicial = start.format('YYYY-MM-DD');

    var fechaFinal = end.format('YYYY-MM-DD');

    var capturarRango = $("#daterangecc-btn span").html();

	var cobrador = $("#campocobrador").attr("value");


   
   	localStorage.setItem("capturarRango", capturarRango);

   	window.location = "index.php?ruta=detallesc&variable="+cobrador+"&fechaInicial="+fechaInicial+"&fechaFinal="+fechaFinal;
...
$(".daterangepicker.opensleft .ranges li").on("click", function(){
	...
	if(textoHoy == "Hoy"){
    	...
    	window.location = "index.php?ruta=detallesv&variable="+cobrador+"&fechaInicial="+fechaInicial+"&fechaFinal="+fechaFinal;
